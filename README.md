...
| `tests` | Differential test suite (190 tests: translated Rust output vs. expected output) |
...
the tests. The suite currently contains **190 differential tests**:
...
- `String.format()`, `String.join()`, `String.formatted()` (Java 15+), `String.toUpperCase()`, `String.toLowerCase()`, `System.out.printf()`
